        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HalfPortionPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultLunchTime = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSmsNotificationActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyMealSchedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DailyMealSchedules_FoodItems_FoodItemId",
                        column: x => x.FoodItemId,
                        principalTable: "FoodItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DailyMealSchedules_Schools_SchoolId",
                        column: x => x.SchoolId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavoriteFood = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VirtualCardNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wallets_Users_ParentId",
                        column: x => x.ParentId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalRawPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    DiscountAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    FinalPayablePrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SchoolOrders_Children_ChildId",
                        column: x => x.ChildId,
                        principalTable: "Children",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SchoolOrders_Users_ParentId",
                        column: x => x.ParentId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WalletTransactions_Children_ChildId",
                        column: x => x.ChildId,
                        principalTable: "Children",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_WalletTransactions_Users_ParentId",
                        column: x => x.ParentId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FoodTitle = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderItems_SchoolOrders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyMealSchedules_Date_FoodItemId_SchoolId",
                table: "DailyMealSchedules",
                columns: new[] { "Date", "FoodItemId", "SchoolId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DailyMealSchedules_FoodItemId",
                table: "DailyMealSchedules",
                column: "FoodItemId");

            migrationBuilder.CreateIndex(
                name: "IX_DailyMealSchedules_SchoolId",
                table: "DailyMealSchedules",
                column: "SchoolId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SchoolOrders_ChildId",
                table: "SchoolOrders",
                column: "ChildId");

            migrationBuilder.CreateIndex(
                name: "IX_SchoolOrders_OrderCode",
                table: "SchoolOrders",
                column: "OrderCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SchoolOrders_ParentId",
                table: "SchoolOrders",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_Schools_BranchCode",
                table: "Schools",
                column: "BranchCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wallets_VirtualCardNumber",
                table: "Wallets",
                column: "VirtualCardNumber",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletTransactions_ParentId",
                table: "WalletTransactions",
                column: "ParentId");
